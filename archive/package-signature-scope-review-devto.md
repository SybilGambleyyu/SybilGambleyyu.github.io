...
[FormulaFence 0.222.0](https://github.com/SybilGambleyyu/formulafence/releases/tag/v0.222.0)
and [WCAB 0.38.0](https://github.com/SybilGambleyyu/workbook-change-benchmark/releases/tag/v0.38.0)
...
FormulaFence 0.222.0 reads the bounded structure and reports aggregate counts
...
When that aggregate changes, high-severity `FF050` evidence includes:
...
`digital_signature_controls_changed` and `FF050` evidence, while WCAB
independently verifies its public synthetic URI transition. This lets a
...
FormulaFence 0.222.0 passed 1,593 tests. WCAB 0.38.0 has 55 cases, 57 facts,
and 258 passing tests. The full canonical note, with validation details and
