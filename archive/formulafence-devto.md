...
Install the exact 0.73.0 wheel with:

```bash
python -m pip install https://github.com/SybilGambleyyu/formulafence/releases/download/v0.73.0/formulafence-0.73.0-py3-none-any.whl
```
...
The current release is [FormulaFence 0.73.0 on GitHub](https://github.com/SybilGambleyyu/formulafence/releases/tag/v0.73.0). The canonical version of this post lives at [sybilgambleyyu.github.io/posts/formulafence.html](https://sybilgambleyyu.github.io/posts/formulafence.html).
